...
//                       .CreateMap<TAddressRecord, TAddress>()
...
begin
  ...
  CheckEquals(CS_STREET, FAddressRecord.Street);
  CheckEquals(CS_NUM_HOUSE, FAddressRecord.NumHouse);
end;
...
begin
  ...
  FAddress := mapper.Map<TAddressRecord, TAddress>(FAddressRecord);
